...
def game_player_vs_smart_bot(sweets, players, messages):
    ...
    while sweets[0] > 0:
        if sweets[0] == (max_number_move and sweets[0] < max_number_movemax_number_move and sweets[0] > 1):
            move = sweets[0] - 1
...
sweets = sweets_gamesweets_game(players)

winer = game_player_vs_smart_botgame_player_vs_smart_bot(sweets, players, messages)
if not winer:
    printprint('У нас нет победителя.')
else:
    print(
